...
def search_papers(request):
    ...
    """
    try:                
        embeddings_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "PaperMate_v1", "GUI", "embedded_models", "Embeddings", "Embeddings.pkl")
        sentences_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "PaperMate_v1", "GUI", "embedded_models", "Sentences", "Sentences.pkl")
